...
public class LLAPPlanChecker {
    ...
    public LLAPPlanChecker(String str){
        ...
        //"17;" + v0
        //                "49,30,46;" + // fod, mat, energy v1,v2,v3
        //                "7,57,6;" + // prices v4[A], v4[B], v4[C]
        //                "7,1;
        //                20,2;
        //                29,2;" + // amount & delays
        //                "350,10,9,8,28;" + //build1
        //                "408,8,12,13,34;"; //build2
...
//        System.out.println(y + " cost: " + x.get(0));
        this.v1 -= x.get(1);
        this.v2 -= x.get(2);
        this.v3 -= x.get(3);
        this.v12 += x.get(0);
    ...
    public boolean tryPlan(String[] actions, LLAPPlanChecker s) {
		...
		for (int i = 0; i < actions.length; i++) {
			...
			case "requestmaterials":
				linkin = s.f1("B");
                if(!linkin) System.out.println("Failed on request");
				break;
			case "build1":
				linkin = s.f2(1);
                if(!linkin) System.out.println("Failed in building 1");
				break;
			case "build2":
				linkin = s.f2(2);
				break;
...
//    System.out.println(solution);
    ...
    System.out.println("linkin: " + linkin);
	if(!linkin) {
		return false;
		}
    System.out.println(s.cool());
    System.out.println(s.v12);
